...
```{r}
library(ggplot2)
ggplot(data = maltreat , aes(x=weight , y=weight)) + geom_boxplot()
```
...
```{r}
library(ggplot2)
ggplot(data = maltreat , aes(x=sex , y=weight)) + geom_boxplot(fill = "red")
```
...
```{r}
library(ggplot2)
ggplot(data = maltreat , aes(x=sex , y=weight ,fill=paying)) + geom_boxplot()
```
...
```{r}
library(ggplot2)
ggplot(data = maltreat , aes(x=weight , y=heartrate)) + geom_point()
```
...
```{r}
library(ggplot2)
ggplot(data = maltreat , aes(sex)) + geom_bar(fill='grey') + theme_bw() + ggtitle("Barplot of gender")
```
